...
import { friendlyFieldNames, supportedLanguages, mediaGroups, groupDisplayNames } from "../../../shared/constants"
...
export function EditModal({record, isOpen, onClose}: EditModalProps) {
    ...
    const editableFields = ['title', 'productCode', 'targetLanguage', 'wordCount', 'datePublished', 'dateArchived', 'articleUrl', 'editorUrl']
